...
const ConsultingDashboard = () => {
  ...
  return (
    <div className="p-6 bg-gray-50">
      <h1 className="text-3xl font-bold mb-6">Consulting Management Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-green-500">+2% from target</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-blue-500">3 starting next month</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-green-500">+5 this quarter</p>
          </CardContent>
        </Card>
      </div>
